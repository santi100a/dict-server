...
You can [file an issue](https://github.com/santi100a/dict-server/issues)
or a [pull request](https://github.com/santi100a/dict-server/pulls).
You can also [start a discussion](https://github.com/santi100a/dict-server/discussions).
